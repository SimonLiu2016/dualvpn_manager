...
# DualVPN Manager 发布脚本
# 功能：推送变更到 GitHub，打标签，发布新的 Release 版本

echo "========================================="
echo "  DualVPN Manager 发布脚本             "
echo "========================================="
echo
...
if command -v gh &> /dev/null; then
        ...
        if [ -n "$RELEASE_NOTES_PATH" ]; then
            ...
            if [ -f "$RELEASE_NOTES_PATH" ]; then
                ...
                gh release create "v$VERSION" \
                    --title "DualVPN Manager v$VERSION" \
                ...
                if [ $? -eq 0 ]; then
                    ...
                    echo "   访问 https://github.com/SimonLiu2016/dualvpn_manager/releases/new"
                fi
    ...
    echo "1. 访问 https://github.com/SimonLiu2016/dualvpn_manager/releases/new"
